...
Background: 
	...
	| PropertyName                                 | Avatar                                           | Images                                                                            | PropertyType | Content                                                                                                      | Street          | Ward        | District | Price  | UnitPrice | Area  | BedRoom | BathRoom | PackingPlace | UserID                   | Created_at | Create_post | Status   | Note | Updated_at | Sale_ID |
