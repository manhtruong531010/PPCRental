...
Scenario: Post Project
	Given I input 'lythihuyenchau@gmail.com' and '123456' into Login page
	When i input following information
	| PropertyName                                 | Avarta                                           | Images                                                                            | PropertyType | Content                                                                                                      | Street          | Ward        | District | Price  | UnitPrice | Area  | BedRoom | BathRoom | PackingPlace | UserID       | Create_at  | Create_post | Status   | Note | Update_at  | Sale_ID        |
	| test post 22                                  | PIS_7319-Edit-stamp.jpg                          | PIS_7319-Edit-stamp.jpg                                                           | Office       | The surrounding neighborhood is very much localized with a great number of local shops.                      | Cô Bắc          | P.Cô Giang  | Q.1      | 99999  | VND       | 120m2 | 3       | 2        | 1            | Lý Châu      | 2017-12-25 | 2017-12-25  | Đã duyệt | Done   | 2017-11-23 | Chi Võ         |  
	
	Then I want see list project
	| PropertyName                                 |
	| PIS Top Apartment                            |
	| ViLa Q7                                      |
